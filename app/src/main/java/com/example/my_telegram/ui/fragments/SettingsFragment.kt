...
import com.example.my_telegram.databinding.FragmentSettingsBinding
...
//Todo интересная реализация надувания фрагмента, потом ее убрали и сделали по другому
    /*  override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                                savedInstanceState: Bundle?): View? {
          mBinding = FragmentSettingsBinding.inflate(layoutInflater)
          //return inflater.inflate(R.layout.fragment_chat, container, false)
          return mBinding.root  //хотелось бы посмотреть что это за код
      }*/
